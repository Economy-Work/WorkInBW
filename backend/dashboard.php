        ...
        <div class="stepper d-flex flex-column mt-5 ml-2">
          ...
          <div class="d-flex mb-1">
            <div class="d-flex flex-column pr-4 align-items-center">
              ...
              <div class="line border-end border-2 border-gray h-100"></div>
            </div>
            <div class="ps-3 pb-3">
              <h5 class="pt-2">
          ...
          <div class="d-flex mb-1">
            <div class="d-flex flex-column pr-4 align-items-center">
              <div class="rounded-circle py-2 px-3 bg-body-secondary mb-1"><?php echo $step_num+1; ?></div>
            </div>
            <div class="ps-3 pb-3">
              <h5 class="pt-2">
                View your Results
              </h5>
              <p class="lead text-muted">We'll share your Profile with interested employers for you.</p>
              <?php
              if($completed && !$action_shown){
              ?>
